...
- Create a subset of the data for countries beginning with the letter `S` in Africa
    + HINT: the function `substr` can be used to 

```{r}
filter(gapminder,substr(country,1,1)== "S",continent=="Africa")
```
